...
{{
    "decision": "request_additional_info",
    "message": "<your message to the small language model>" # consider adding details about the tool call you want to make -- i.e., Please read the file (read_file where path="~/Downloads/summary.pdf') and extract the information about the company
}} 
```
